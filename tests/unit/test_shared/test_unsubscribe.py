...
from src.shared.unsubscribe_service import UnsubscribeService
...
class TestUnsubscribeService(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures."""
        self.config_patcher = patch('src.shared.unsubscribe_service.config')
        self.mock_config = self.config_patcher.start()
        
        self.subscriber_service_patcher = patch('src.shared.unsubscribe_service.SubscriberService')
